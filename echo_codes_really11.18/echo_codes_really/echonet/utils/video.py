    ...
    with open(os.path.join(output, "log.csv"), "a") as f:
        ...
        if run_test:
            for split in ["val", "test"]:
                ...
                loss, yhat, y = echonet.utils.video.run_epoch(model, dataloader, False, None, device, save_all=True, block_size=10)
...
if __name__ == '__main__':
    run(num_epochs=2, modelname="r2plus1d_18", frames=32, period=2, pretrained=True, batch_size=2)
